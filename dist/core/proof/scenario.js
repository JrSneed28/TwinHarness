...
exports.ScenarioIsolationError = void 0;
exports.scenarioMarkerPath = scenarioMarkerPath;
exports.startScenario = startScenario;
exports.finishScenario = finishScenario;
 ...
 */
class ScenarioIsolationError extends Error {
    code = "scenario_isolation";
    constructor(scenarioRoot, resolvedRoot) {
        super(`scenario root ${scenarioRoot} resolves to an ancestor project root ${resolvedRoot}; ` +
            `it must be isolated (no ancestor .twinharness). Refusing to scaffold.`);
        this.name = "ScenarioIsolationError";
    }
}
exports.ScenarioIsolationError = ScenarioIsolationError;
...
function startScenario(brief) {
    ...
    const scenarioPaths = (0, paths_1.resolveProjectPaths)(scenarioRoot);
    ...
    (0, init_1.runInit)(scenarioPaths, { brownfield: brief.type === "brownfield" });
    // M3: enable local telemetry so the live run's route/scorecard stats are captured.
    (0, telemetry_1.writeTelemetryConfig)(scenarioPaths, { enabled: true });
    ...
    const marker = {
        scenario,
        baselineManifest: (0, manifest_1.buildManifest)(scenarioPaths),
