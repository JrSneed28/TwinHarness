...
- `th` CLI with **2,000+ tests** covering CLI behavior, plugin-packaging integrity, security containment (path traversal, proto-pollution), the repo-understanding layer, decision governance (hash-chain tamper detection, TTY barrier), brownfield tiering, and the full 78-tool MCP surface.
