...
This table is generated from the CLI dispatcher and the MCP `TOOL_DEFS` registry (`scripts/gen-command-reference.ts`); do not edit it by hand. There are **108 CLI command leaves** and **79 MCP tools**.
...
#### MCP tool roster (exhaustive — all 79)
