...
const OPTIONAL_STATE_FIELDS = ["schema_version", "write_gate", "project_mode", "debate_open_blocking", "interview_cutoff", "delivery_mode", "has_ui", "interview_required", "max_tokens"];
