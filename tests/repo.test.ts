...
describe("REQ-NFR-002: TOOL_DEFS baseline — exactly 18 tools registered (SLICE-1 added th_build_sub_claim/sub_release; SLICE-4 added 4 repo-map tools; delegate layer added 3)", () => {
  // Anchor: REQ-NFR-002
  ...
  it("REQ-NFR-002 — TOOL_DEFS.length === 18 (SLICE-1 added th_build_sub_claim/sub_release; SLICE-4 added th_repo_map/relevant/impact/context_pack; delegate layer added th_delegate_plan/pack/check)", () => {
    expect(TOOL_DEFS.length).toBe(18);
  });

  it("REQ-NFR-002 — TOOL_DEFS contains exactly the 18 expected tool names", () => {
