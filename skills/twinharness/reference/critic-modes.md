# TwinHarness Critic Modes — Reference (part of the TwinHarness orchestrator playbook)

This file contains the full per-mode grounded-defect checklists for the Critic agent. When you
are the Critic and need the detailed checklist for your mode, find your mode's section below.
Every rule here is verbatim from the original agent definition.
