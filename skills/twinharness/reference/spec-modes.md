...
This file contains the full per-mode section lists and completion criteria for the Spec agent.
When you are the Spec agent and need the detailed sections, completion criteria, and behavioral
rules for your mode, find your mode below. Every `th` command, §-citation, and behavioral rule
here is canonical.
